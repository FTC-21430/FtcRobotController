...
@Autonomous(name="Autonomous_Route_Seal_RLeft_19_v2", group="Monkey")
public class Autonomous_Route_Seal_RLeft_19_v2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Autonomous_Route_Seal_RLeft_19_v2.SamplePipeline pipeline =  new Autonomous_Route_Seal_RLeft_19_v2.SamplePipeline();
...
//        leftFrontMotor.setPower(0.85);
        ...
        sleep(1500);
        encoderDrive(0.3, 0.46,0.46,0.46,0.46,5 );
        ...
        //open
        sleep(1000);
        encoderDrive(0.3, -0.42,-0.42,-0.42,-0.42,5 );
        //First Backwards
